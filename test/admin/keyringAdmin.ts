...
import { unacceptable, unauthorized, applyPolicyChanges, sortAscendingOrder, walletCheckKeyGen } from "../helpers";
...
describe("Admin", function () {
  ...
  describe("Keyring Admin", function () {
    ...
    it("should only allow to set policy paremeters within the requirements", async function () {
      ...
      ).to.be.revertedWith(unacceptable("Cannot configure policy 0"));
