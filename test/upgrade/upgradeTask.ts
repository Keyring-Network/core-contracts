...
describe("Upgrade Task", () => {
    ...
    it("should upgrade KeyringCredentials", async () => {
        ...
        const credentials = await hre.ethers.getContractAt("KeyringCredentials", data.contracts["KeyringCredentials"].address);
    ...
    it("should upgrade ExemptionsManager", async () => {
        ...
        const exemptionsManager = await hre.ethers.getContractAt("ExemptionsManager", data.contracts["ExemptionsManager"].address);
